...
public class JudgeAnswersAfterHimSelfCellTest {
	...
	public void test_1pokemon() {
		...
		judgeBot.IncrNb_Rounds_en_cours();
		judgeBot.pushPokemon("@bulbizarre", "@nedseb", null, null);
		assertEquals(null, 
				HimSelfcell.ask(new Tweet("PokeConquerors", "@bulbiVraimentZarbi -10pc /cc @nedseb #1")));
	}
	...
	public void test_Round1() {
		...
		assertEquals(null, HimSelfcell.ask(new Tweet("PokeConquerors", "Round #1 /cc @nebsed @bulbizarbi @nedseb @bulbizarre")));
	}
}
