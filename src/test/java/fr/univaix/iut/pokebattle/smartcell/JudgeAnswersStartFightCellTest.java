...
public class JudgeAnswersStartFightCellTest {
    ...
    public void testSalut() {
        ...
        assertEquals(
                "Round #1 /cc @pcreux @bulbizare1 @nedseb @pikachuNyanNian",
    ...
    public void testSalut1() {
        ...
        assertEquals("Je suis déjà en combat, veuillez me "
                ...
                + " cordialement", cell2.ask(new Tweet("nedseb",
                "@pcreux #fight #ok with @pikachuNyanNian /cc @viviane")));
    }
    ...
    public void testNb_Fight_toomany() {
        List<Date> l = Arrays.asList(new Date(4448), new Date(65595), new Date(
                5448), new Date(6659), new Date(959));
