...
public class CredentialsTest {
    ...
    public void testLoadCredentialsGivenAValidPropertiesFileShouldReturnAValidCredentials() throws Exception {
        ...
        assertThat(credentials.getConsumerSecret()).isEqualTo("dmhQaM8sGbxcnmGvmTTRBSRNNHj3QFNbhSJfeNLoaQ");
        assertThat(credentials.getToken()).isEqualTo("2363180089-BcQpKRKLAMQk4SWHtZBDt8hS4S6XXn4kiFR9XvG");
        assertThat(credentials.getTokenSecret()).isEqualTo("V2T8WocryKa8HIYRPoPE8CV0tmg7aiY0Smn9SgiQ83Apc");
    }
}
