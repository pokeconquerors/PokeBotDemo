...
public class DataObjectPokemonTest {
	...
	public void test_ToString() {
		...
		DataObjectPokemon dop = new  DataObjectPokemon(nom, espece, taille, poids, fmratio, effortval,
										               type1, type2, expval, expmax, 
										               captureval, capspe1, capspe2, couleur, forme, 
										               attaques);
		String pokemon = "DataObjectPokemon{" +
                "nom='" + nom + '\'' +
                ", espece='" + espece + '\'' +
                ", taille=" + taille +
                ", poids=" + poids +
